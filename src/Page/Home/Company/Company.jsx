...
const Compani = () => {
  return (
    <div>
      <div className="w-full z-10 flex flex-col pt-10 justify-center items-center">
        <h3 className="text-xl md:text-3xl uppercase text-[#312720] font-bold ">
          Trusted by Leading Brands
        </h3>
        <img src={design} alt="design" className="w-[250px]" />
      </div>
      <div className="container mx-auto py-8 grid grid-cols-3 md:grid-cols-6">
