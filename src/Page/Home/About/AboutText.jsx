    ...
    <div className=" mx-auto py-10 px-2 dark:bg-gray-900 dark:text-white">
      ...
      <div className="max-w-[1000px] mx-auto p-2">
        <p className="text-justify">
          At Osman Premium Property, we redefine the standard of luxury living.
          Our journey began with a vision to create an unparalleled living
          experience within a single building. With a focus on premium amenities
          and exceptional services, Osman Premium Property is dedicated to
          providing a lifestyle of comfort, convenience, and elegance.
        </p>
        <div className="w-full mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="w-full p-3">
            ...
            <p className="text-justify">
              At Osman Premium Property, our commitment is to excellence in
              every aspect. We pride ourselves on providing a secure, inclusive,
              and vibrant community for our residents. With top-notch security,
